...
// Duracion teorica de cada fase (fuente unica para timeline y sincronias)
export const PHASE_DURATION_MS = {
  [INTERNAL_STATES.INERCIA_VIVA]: INITIAL_STATE_TRANSITION_DELAY_MS,
  [INTERNAL_STATES.PULSO_INICIAL]: PULSO_INICIAL_TO_DESLIZAMIENTO_DELAY_MS,
  [INTERNAL_STATES.DESLIZAMIENTO_INTERNO]: DESLIZAMIENTO_INTERNO_TO_RITMO_EMERGE_DELAY_MS,
  [INTERNAL_STATES.RITMO_EMERGE]: RITMO_EMERGE_TO_DISTORSION_DELAY_MS,
  [INTERNAL_STATES.DISTORSION_APERTURA]: DISTORSION_APERTURA_TO_QUIETUD_TENSA_DELAY_MS,
  [INTERNAL_STATES.QUIETUD_TENSA]: DISTORSION_APERTURA_TO_QUIETUD_TENSA_DELAY_MS,
};
...
// Fases de conciencia alta y tinte dorado para halo/campo/susurro final
