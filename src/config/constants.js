...
export const DISTORSION_APERTURA_OUTER_FIELD_OPACITY = 0.11;
export const DISTORSION_APERTURA_OUTER_FIELD_VARIATION = 0.95;

export const QUIETUD_TENSA_OUTER_FIELD_SCALE_MULTIPLIER = 1.1;
export const QUIETUD_TENSA_OUTER_FIELD_OPACITY = 0.07;
export const QUIETUD_TENSA_OUTER_FIELD_VARIATION = 0.45;
